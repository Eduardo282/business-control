...
export function buildQuotePdfHtml(quote) {
  ...
  const itemsHtml = pricing.items
    ...
    <tr style="border-bottom: 1px solid #f1f5f9;">
      ...
      <td style="padding: 16px; text-align: right; color: #475569; vertical-align: top; font-family: monospace;">${currencyFormatter.format(baseUnitPrice)}</td>
      <td style="padding: 16px; text-align: right; color: ${discount > 0 ? "#dc2626" : "#475569"}; vertical-align: top; font-family: monospace;">${discount.toLocaleString("es-MX", { maximumFractionDigits: 2 })}%</td>
      <td style="padding: 16px; text-align: right; color: #475569; vertical-align: top; font-family: monospace;">${currencyFormatter.format(discountedUnitPrice)}</td>
      <td style="padding: 16px 0 16px 16px; text-align: right; font-weight: bold; color: #0f172a; vertical-align: top; font-family: monospace;">${currencyFormatter.format(lineTotal)}</td>
    </tr>`;
    })
    .join("");
        ...
        <div class="container">
          ...
          <div class="totals">
            <div class="totals-box">
              ...
              <div class="total-row"><span>Descuento</span> <span class="total-mono">-${currencyFormatter.format(totalDiscountAmount)}</span></div>
              ...
              <div class="total-final"><span class="final-label">Total Neto</span> <span class="final-value">${currencyFormatter.format(total)}</span></div>
            </div>
          </div>
