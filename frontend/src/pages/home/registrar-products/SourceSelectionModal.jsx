...
import { X, Package, ShoppingBag, Library, ChevronDown } from "@icons";
...
export default function SourceSelectionModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-zinc-500/50 dark:bg-black/70 backdrop-blur-sm">
      <div className="bg-[#1a2b4c] dark:bg-blue-950 rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl dark:shadow-black/60 animate-fade-in relative border border-white/15 dark:border-white/10">
        ...
        <div className="p-4 space-y-4 bg-white dark:bg-dark-800 rounded-b-2xl">
