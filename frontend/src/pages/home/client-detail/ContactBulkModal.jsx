            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  className="w-full px-3 py-2 pr-8 rounded-lg border border-zinc-300 dark:border-dark-700 text-sm text-zinc-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-[#2277B4]/30 focus:border-[#2277B4] bg-white dark:bg-dark-800"
                />
                {bulkContactDriveUrl && (
                  <button
                    type="button"
                    onClick={clearBulkContactDriveUrl}
