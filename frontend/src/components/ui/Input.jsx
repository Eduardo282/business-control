  ...
  return (
    <div className="w-full space-y-1.5">
      ...
      <div className="relative">
        <input
          {...props}
          className={`w-full rounded-xl px-4 py-3 text-sm bg-white text-light-text-primary dark:placeholder:text-slate-500 focus:ring-2 focus:ring-[#153465] focus:outline-none border border-gray-300 disabled:bg-gray-100 disabled:text-gray-500 disabled:border-gray-200 disabled:cursor-not-allowed disabled:placeholder:text-gray-400 disabled:focus:ring-0 ${
            error ?
