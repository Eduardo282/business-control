import{c as o}from"./index-BH9wGhQj.js";const c="http://localhost:4000/graphql",u=c.replace(/\/graphql\/?$/i,"");function i(e){return`${u}${e}`}async function d(e){var a;const n=`
  ...
  `,{data:t}=await o.post("",{query:n,variables:{input:e}});if((a=t.errors)!=null&&a.length)throw new Error(t.errors[0].message);return t.data.createContact}async function l(e,n){var r;const t=`
  ...
  `,{data:t}=await o.post("",{query:n,variables:{inputs:e}});if((a=t.errors)!=null&&a.length)throw new Error(t.errors[0].message);return t.data.bulkCreateContacts}async function y(e){const{data:n}=await o.get(i(`/api/contacts/client/${e}/dynamic`));return n}async function f(e,n){const{data:t}=await o.put(i(`/api/contacts/${e}/dynamic`),n);return t}async function g({fileUrl:e,clientId:n}){var t,a;try{const{data:r}=await o.post(i("/api/contacts/import-drive"),{fileUrl:e,clientId:n});return r}catch(r){const s=((a=(t=r==null?void 0:r.response)==null?void 0:t.data)==null?void 0:a.message)||(r==null?void 0:r.message)||"No se pudo importar el archivo desde Drive.";throw new Error(s)}}export{l as a,w as b,d as c,C as d,m as e,h as f,g as i,y as l,f as u};
