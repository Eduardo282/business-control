import{i as n}from"./index-B_2HdQMN.js";const o=n.create({baseURL:"http://localhost:4000/graphql",headers:{"Content-Type":"application/json"}});o.interceptors.request.use(r=>{const t=sessionStorage.getItem("bc_portal_token");return t&&(r.headers.Authorization=`Bearer ${t}`),r});async function u(r,t){var s;const e=`
